...
def save_hard_example(net, data,save_path):
    ...
    # save files
    neg_label_file = "M:/MTCNN/data/%d/neg_%d.txt" % (net, image_size)
    neg_file = open(neg_label_file, 'w')

    pos_label_file = "M:/MTCNN/data/%d/pos_%d.txt" % (net, image_size)
    pos_file = open(pos_label_file, 'w')

    part_label_file = "M:/MTCNN/data/%d/part_%d.txt" % (net, image_size)
...
if __name__ == '__main__':
    ...
    base_dir = 'M:/MTCNN/data/WIDER_train'
    data_dir = 'M:/MTCNN/data/no_LM%s' % str(image_size)
